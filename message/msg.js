...
const { color, bgcolor } = require('../libcolor')
const { getBuffer, fetchJson, fetchText, getRandom, getGroupAdmins, runtime, sleep, makeid } = require("../libmyfunc");
const { webp2mp4File } = require("../libconvert")
const { pinterest } = require("../libpinterest")
const { isLimit, limitAdd, getLimit, giveLimit, addBalance, kurangBalance, getBalance, isGame, gameAdd, givegame, cekGLimit } = require("../liblimit");
const { isTicTacToe, getPosTic } = require("../libtictactoe");
const { addPlayGame, getJawabanGame, isPlayGame, cekWaktuGame, getGamePosi } = require("../libgame");
const tictac = require("../libtictac");
const _prem = require("../libpremium");
